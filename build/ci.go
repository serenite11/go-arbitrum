...
import (
	...
	"github.com/serenite11/go-ethereum/crypto/signify"
	"github.com/serenite11/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/serenite11/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/serenite11/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/serenite11/go-ethereum/core/rawdb", "github.com/serenite11/go-ethereum/ethdb/leveldb"},
		{"github.com/serenite11/go-ethereum/core/rawdb", "github.com/serenite11/go-ethereum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
